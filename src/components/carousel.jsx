...
export function CarouselComponent({
  ...
  if (images.length === 0) {
    return <div className="md:relative md:w-full hidden  mx-auto" style={{ aspectRatio: '10/ 3' }}>No images available</div>;
  }

  return (
    <div className="md:relative md:w-full md:block hidden">
      <div className="overflow-hidden rounded-lg" style={{ aspectRatio: '10 / 2' }}>
